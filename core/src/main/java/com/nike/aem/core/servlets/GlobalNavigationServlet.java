...
import com.nike.aem.core.models.GlobalNavCFModel;
...
@Component(
        ...
        property = {
                SLING_SERVLET_PATHS + "=/api/getGlobalNavMenu",
                SLING_SERVLET_METHODS + "=" + HttpConstants.METHOD_GET,
                SLING_SERVLET_EXTENSIONS + "=" + "json"
        }
)
@ServiceDescription("Global Navigation Servlet")
public class GlobalNavigationServlet extends SlingSafeMethodsServlet {

    private static final Logger LOG = LoggerFactory.getLogger(GlobalNavigationServlet.class);
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
        try {
            ...
            GlobalNavCFModel contentFragmentModel = contentFragmentService.getFragment(request.getResourceResolver(), contentFragmentResourcePath,GlobalNavCFModel.class);
